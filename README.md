...
The exe file for this script shows the [Tkinter](https://docs.python.org/3/library/tkinter.html) window along with a print in the terminal that asks the user to **Please select the python.exe file to install:**. The user should select the file **[python-3.7.0-amd64](/exe_installation/python-3.7.0-amd64.exe)** and the installation will be done automatically. After that, the window and the terminal will shut down.

<!-- ![This is an image](https://myoctocat.com/assets/images/base- octocat.svg) -->
![Alt text](./script_images/script_1.png)
...
![Alt text](./script_images/script_2.png)
...
![Alt text](./script_images/script_3.png)
